...
> Transcrição do `Exercício.docx` entregue pelo professor.
> Fonte: `~/Downloads/Exercício.docx` (md5 `f01ced781b6de1f2f0e3c3f572d44ce0`).
...
> **Nota do grupo:** o enunciado se contradiz aqui — "10 linhas no máximo" vs.
